...
import { ArrowLeft, Clock, ArrowRight, Send, Check } from 'lucide-react';
...
export default function MockExamPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 animate-in fade-in duration-500">
      ...
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 text-slate-500 hover:text-[#800020] transition-colors font-bold text-sm mb-6"
      >
        <ArrowLeft size={16} />
        Back to Course
      </button>
      ...
      <div className="bg-white rounded-[24px] shadow-sm border border-slate-100 flex flex-col overflow-hidden">
        ...
        <div className="bg-[#800020] text-white px-6 py-5 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold">JavaScript Basics Quiz</h2>
        ...
        <div className="flex flex-col lg:flex-row flex-1">
          ...
          <div className="flex-1 flex flex-col border-r border-slate-100 min-h-[600px]">
            {/* Top Bar */}
          ...
          <div className="w-full lg:w-[320px] bg-slate-50/50 flex flex-col shrink-0">
            ...
            <div className="p-6 border-b border-slate-200">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-6">
                ...
                <div className="flex items-center gap-1.5">
                  <div className="w-3 h-3 rounded-full bg-emerald-500 flex items-center justify-center text-white"><Check size={8} strokeWidth={4} /></div>
