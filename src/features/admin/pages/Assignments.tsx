...
export default function Assignments() {
  ...
  const [selectedAssignmentForView, setSelectedAssignmentForView] =
    useState<HomeworkItem | null>(null);
  const [selectedAssignmentForEdit, setSelectedAssignmentForEdit] =
    useState<HomeworkItem | null>(null);
  ...
  const [isAssignmentAddModalOpen, setIsAssignmentAddModalOpen] =
    useState<boolean>(false);
  ...
  const text = {
    ...
    subtitle: {
      ar: "عرض وتتبع جميع الواجبات المسندة",
      en: "View and track all assigned homework",
    },
    search: {
