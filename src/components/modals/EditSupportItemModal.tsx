import { X, Edit2, Link, FileText, Layout } from 'lucide-react';
...
export default function EditSupportItemModal({ isOpen, onClose, onSubmit, categories, support }: EditSupportItemModalProps) {
    ...
    useEffect(() => {
        if (support) {
            reset({
                title_ar: support.title_ar || support.title || '',
                title_en: support.title_en || '',
                url: support.url,
                description_ar: support.description_ar || support.description || '',
                description_en: support.description_en || '',
            ...
            <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-lg overflow-hidden flex flex-col border border-slate-100 animate-in zoom-in-95 duration-300">
                ...
                <div className="px-8 py-6 border-b border-slate-50 flex items-center justify-between bg-white sticky top-0 z-10">
                    <div>
                        ...
                        <p className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-widest">Update Help Item</p>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                    <form id="edit-support-item-form" onSubmit={handleSubmit(handleOnSubmit)} className="p-8 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-start">
                            <div>
                                ...
                                <textarea
                                    rows={3}
                                    dir="rtl"
                                    placeholder="وصف مختصر للمصدر بالعربية..."
                        ...
                        <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl">
                            ...
                            />
                            <label htmlFor="item-active" className="text-sm font-bold text-slate-600 cursor-pointer">
                                Active Resource
                            </label>
                        </div>
                    </form>
